...
local V = { 
    ...
    Name = 'Alpina B10 E34 Bi-Turbo 1989',
    Model = 'models/crsk_autos/bmw/alpina_b10.mdl',
    ...
    FrontRelativeDamping = 2148, 
    RearRelativeDamping = 2148,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_alpina_b10', V ) 