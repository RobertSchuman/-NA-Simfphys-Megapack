...
local V = { 
    ...
    Name = 'Rolls-Royce Wraith 2013',
    Model = 'models/crsk_autos/rolls-royce/wraith_2013.mdl',
    ...
    FrontRelativeDamping = 2152, 
    RearRelativeDamping = 2152,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_wraith_2013', V ) 