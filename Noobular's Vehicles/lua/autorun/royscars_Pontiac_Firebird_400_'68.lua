...
local V = { 
    ...
    Name = 'Pontiac Firebird 400 '68',
    Model = 'models/royscars/pontiac/pontiac_firebird_68.mdl',
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_pontiac_firebird_68', V ) 