...
local V = { 
    ...
    Name = 'Pontiac GTO Hardtop '68',
    Model = 'models/royscars/pontiac/pontiac_gto_68.mdl',
    ...
    FrontRelativeDamping = 2048, 
    RearRelativeDamping = 2048,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_pontiac_gto_68', V ) 