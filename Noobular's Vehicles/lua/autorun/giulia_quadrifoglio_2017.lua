...
local V = { 
    ...
    Name = 'crsk_alfa_giulia_quadrifoglio_2017',
    ...
    FrontRelativeDamping = 2111, 
    RearRelativeDamping = 2111,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_giulia_quadrifoglio_2017', V ) 