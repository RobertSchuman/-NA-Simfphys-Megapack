...
local V = { 
    ...
    Name = 'Ford FPV Limited Edition Pusuit [FG]',
    Model = 'models/royscars/ford/ford_pursuit_ute.mdl',
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_ford_pursuit_ute', V ) 