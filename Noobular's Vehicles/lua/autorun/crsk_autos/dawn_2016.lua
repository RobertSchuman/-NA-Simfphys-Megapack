...
local V = { 
    ...
    Name = 'crsk_rolls-royce_dawn',
    Model = 'models/crsk_autos/rolls-royce/dawn_2016.mdl',
    ...
    FrontWheelRadius = 17.10000038147,
    RearWheelRadius = 17.10000038147,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_dawn_2016', V ) 