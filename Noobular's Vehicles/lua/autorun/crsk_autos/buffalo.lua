...
local V = { 
    ...
    Name = 'crsk_gtasa_buffalo',
    Model = 'models/crsk_autos/gtasa/buffalo.mdl',
    ...
    FrontRelativeDamping = 1791, 
    RearRelativeDamping = 1791,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_buffalo', V ) 