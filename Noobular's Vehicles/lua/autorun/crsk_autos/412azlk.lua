...
local V = { 
    ...
    Name = 'crsk_moskvich_412azlk',
    Model = 'models/crsk_autos/moskvich/412azlk.mdl',
    ...
    FrontRelativeDamping = 1737, 
    RearRelativeDamping = 1737,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_412azlk', V ) 