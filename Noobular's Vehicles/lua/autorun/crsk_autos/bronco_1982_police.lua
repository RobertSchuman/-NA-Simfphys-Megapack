...
local V = { 
    ...
    Name = 'crsk_ford_bronco_1982_police',
    ...
    FrontRelativeDamping = 2882, 
    RearRelativeDamping = 2882,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_bronco_1982_police', V ) 