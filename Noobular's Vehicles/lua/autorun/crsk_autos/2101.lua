...
local V = { 
    ...
    FrontWheelRadius = 12.699999809265,
    RearWheelRadius = 12.699999809265,
    ...
    FrontRelativeDamping = 747, 
    RearRelativeDamping = 747,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_2101', V ) 