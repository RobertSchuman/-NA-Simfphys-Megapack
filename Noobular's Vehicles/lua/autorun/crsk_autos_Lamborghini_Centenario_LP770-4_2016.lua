...
local V = { 
    ...
    Name = 'Lamborghini Centenario LP770-4 2016',
    Model = 'models/crsk_autos/lamborghini/centenario.mdl',
    ...
    FrontWheelRadius = 16.329999923706,
    RearWheelRadius = 16.329999923706,
    ...
    FastSteeringAngle = 9.1999998092651,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_centenario', V ) 