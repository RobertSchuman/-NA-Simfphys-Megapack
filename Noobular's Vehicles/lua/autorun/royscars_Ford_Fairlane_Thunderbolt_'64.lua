...
local V = { 
    ...
    Name = 'Ford Fairlane Thunderbolt '64',
    Model = 'models/royscars/ford_fairlane.mdl',
    ...
    FrontRelativeDamping = 1435, 
    RearRelativeDamping = 1435,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_ford_fairlane', V ) 