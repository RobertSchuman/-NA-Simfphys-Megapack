...
local V = { 
    ...
    Name = 'crsk_mitsubishi_galante39a',
    ...
    FrontWheelRadius = 13.800000190735,
    RearWheelRadius = 13.800000190735,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_galante39a_1987', V ) 