...
local V = { 
    ...
    Name = 'Toyota Sprinter Trueno 'Black Limited' [AE86]',
    ...
    FrontRelativeDamping = 1281, 
    RearRelativeDamping = 1281,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_toyota_black_limited', V ) 