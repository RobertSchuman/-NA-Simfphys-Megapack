...
local V = { 
    ...
    Name = 'Ford Thunderbird '57',
    Model = 'models/royscars/ford_thunderbird.mdl',
    ...
    FrontRelativeDamping = 1317, 
    RearRelativeDamping = 1317,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_ford_thunderbird', V ) 