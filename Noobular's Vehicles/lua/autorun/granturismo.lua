...
local V = { 
    ...
    Name = 'granturismosped',
    Model = 'models/spedcars/granturismo.mdl',
    ...
    FrontRelativeDamping = 2211, 
    RearRelativeDamping = 2211,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_spedcars_granturismo', V ) 