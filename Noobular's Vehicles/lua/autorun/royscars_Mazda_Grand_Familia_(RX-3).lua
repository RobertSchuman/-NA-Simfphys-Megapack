...
local V = { 
    ...
    Name = 'Mazda Grand Familia (RX-3)',
    Model = 'models/royscars/mazda/mazda_rx-3.mdl',
    ...
    FrontRelativeDamping = 1094, 
    RearRelativeDamping = 1094,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_mazda_rx-3', V ) 