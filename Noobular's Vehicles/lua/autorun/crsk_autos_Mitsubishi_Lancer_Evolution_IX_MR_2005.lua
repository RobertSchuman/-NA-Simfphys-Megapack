...
local V = { 
    ...
    Model = 'models/crsk_autos/mitsubishi/lancer_evo_ix.mdl',
    ...
    FrontWheelRadius = 14.300000190735,
    RearWheelRadius = 14.300000190735,
    ...
    FrontRelativeDamping = 1552, 
    RearRelativeDamping = 1552,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_lancer_evo_ix', V ) 