...
local V = { 
    ...
    Name = 'perryn_formula_e_2017',
    Model = 'models/perrynsvehicles/formula_e_2017/formula_e_2017.mdl',
    ...
    FrontWheelRadius = 18.200000762939,
    RearWheelRadius = 18.200000762939,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_perrynsvehicles_formula_e_2017', V ) 