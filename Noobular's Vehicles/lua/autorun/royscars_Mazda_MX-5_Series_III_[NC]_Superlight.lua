...
local V = { 
    ...
    Name = 'Mazda MX-5 Series III [NC] Superlight',
    Model = 'models/royscars/mazda/mazda_mx5_superlight.mdl',
    ...
    FrontRelativeDamping = 1176, 
    RearRelativeDamping = 1176,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_mazda_mx5_superlight', V ) 