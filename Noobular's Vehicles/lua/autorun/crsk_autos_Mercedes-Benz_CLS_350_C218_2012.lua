...
local V = { 
    ...
    Name = 'Mercedes-Benz CLS 350 C218 2012',
    Model = 'models/crsk_autos/mercedes-benz/cls_c218.mdl',
    ...
    FrontRelativeDamping = 2294, 
    RearRelativeDamping = 2294,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_cls_c218', V ) 