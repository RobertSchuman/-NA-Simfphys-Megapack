...
local V = { 
    ...
    Name = 'Ford Falcon GTHO Phase III XY 1971',
    Model = 'models/crsk_autos/ford/falcon_gtho_xy_1971.mdl',
    ...
    FrontWheelRadius = 13.300000190735,
    RearWheelRadius = 13.300000190735,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_falcon_gtho_xy_1971', V ) 