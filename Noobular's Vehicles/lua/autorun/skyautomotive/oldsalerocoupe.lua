...
local V = { 
    ...
    Name = 'sky_alerocoupe_ico',
    Model = 'models/skyautomotive/oldsalerocoupe.mdl',
    ...
    FrontWheelRadius = 12.800000190735,
    RearWheelRadius = 12.800000190735,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_skyautomotive_oldsalerocoupe', V ) 