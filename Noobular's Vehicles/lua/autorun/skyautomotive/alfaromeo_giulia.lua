...
local V = { 
    ...
    Name = 'sky_giulia_ico',
    Model = 'models/skyautomotive/alfaromeo_giulia.mdl',
    ...
    FrontRelativeDamping = 2647, 
    RearRelativeDamping = 2647,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_skyautomotive_alfaromeo_giulia', V ) 