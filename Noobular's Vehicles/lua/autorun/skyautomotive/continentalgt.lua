...
local V = { 
    ...
    Name = 'bentley_cont_ico',
    Model = 'models/skyautomotive/continentalgt.mdl',
    ...
    FrontRelativeDamping = 3235, 
    RearRelativeDamping = 3235,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_skyautomotive_continentalgt', V ) 