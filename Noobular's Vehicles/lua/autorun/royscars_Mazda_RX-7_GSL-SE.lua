...
local V = { 
    ...
    Name = 'Mazda RX-7 GSL-SE',
    Model = 'models/royscars/mazda/mazda_sa22c.mdl',
    ...
    FrontRelativeDamping = 1658, 
    RearRelativeDamping = 1658,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_mazda_sa22c', V ) 