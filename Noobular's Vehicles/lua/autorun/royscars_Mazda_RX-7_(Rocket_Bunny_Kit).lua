...
local V = { 
    ...
    Name = 'Mazda RX-7 (Rocket Bunny Kit)',
    Model = 'models/royscars/rocket_fd3s.mdl',
    ...
    FrontRelativeDamping = 1964, 
    RearRelativeDamping = 1964,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_rocket_fd3s', V ) 