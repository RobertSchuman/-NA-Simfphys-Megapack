...
local V = { 
    ...
    Name = 'Ford Fusion Sport',
    Model = 'models/royscars/ford_fusion.mdl',
    ...
    RearWheelRadius = 15.300000190735,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_ford_fusion', V ) 