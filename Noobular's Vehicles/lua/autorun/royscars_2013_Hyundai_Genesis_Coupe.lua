...
local V = { 
    ...
    Model = 'models/royscars/hyundai_genesis.mdl',
    ...
    FrontRelativeDamping = 2023, 
    RearRelativeDamping = 2023,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_hyundai_genesis', V ) 