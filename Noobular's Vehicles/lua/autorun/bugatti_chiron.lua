...
local V = { 
    ...
    Name = 'sky_bugattichiron_ico',
    Model = 'models/skyautomotive/bugatti_chiron.mdl',
    ...
    FrontRelativeDamping = 2058, 
    RearRelativeDamping = 2058,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_skyautomotive_bugatti_chiron', V ) 