...
local V = { 
    ...
    Name = 'crsk_holden_commodore_ute_ss_2012',
    Model = 'models/crsk_autos/holden/commodore_ute_ss_2012.mdl',
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_commodore_ute_ss_2012', V ) 