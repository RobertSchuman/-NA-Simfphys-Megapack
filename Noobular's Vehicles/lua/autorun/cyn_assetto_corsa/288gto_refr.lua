...
local V = { 
    ...
    Name = 'cyn-cars_ferrari_288gto',
    Model = 'models/cyn_assetto_corsa/ferrari/288gto_refr.mdl',
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_cyn_assetto_corsa_288gto_refr', V ) 