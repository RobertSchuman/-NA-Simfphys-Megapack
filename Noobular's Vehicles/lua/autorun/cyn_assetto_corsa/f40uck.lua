...
local V = { 
    ...
    Name = 'cyn-cars_ferrari_f40',
    Model = 'models/cyn_assetto_corsa/ferrari/f40uck.mdl',
    ...
    FrontRelativeDamping = 1470, 
    RearRelativeDamping = 1470,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_cyn_assetto_corsa_f40uck', V ) 