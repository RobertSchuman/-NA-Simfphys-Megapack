...
local V = { 
    ...
    FrontWheelRadius = 20.700000762939,
    RearWheelRadius = 20.700000762939,
    ...
    FrontRelativeDamping = 2905, 
    RearRelativeDamping = 2905,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_tdmcars_for_f350', V ) 