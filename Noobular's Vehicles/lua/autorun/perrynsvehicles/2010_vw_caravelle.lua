...
local V = { 
    ...
    Name = 'perryn_2010_vw_caravelle',
    Model = 'models/perrynsvehicles/2010_vw_caravelle/2010_vw_caravelle.mdl',
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_perrynsvehicles_2010_vw_caravelle', V ) 