...
local V = { 
    ...
    Name = 'Nissan Fairlady Z 432 [S30]',
    Model = 'models/royscars/nissan/nissan_240z.mdl',
    ...
    FrontRelativeDamping = 1447, 
    RearRelativeDamping = 1447,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_nissan_240z', V ) 