...
local V = { 
    ...
    Name = 'crsk_ferrari_812superfast_2017',
    Model = 'models/crsk_autos/ferrari/812superfast_2017.mdl',
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_812superfast_2017', V ) 