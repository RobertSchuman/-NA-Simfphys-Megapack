...
local V = { 
    ...
    Name = 'Pontiac Trans Am GTA [W87]',
    Model = 'models/royscars/pontiac/pontiac_transam_gta.mdl',
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_pontiac_transam_gta', V ) 