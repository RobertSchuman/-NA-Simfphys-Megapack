...
local V = { 
    ...
    Name = 'Mazda RX-8 R3 [FE3S]',
    Model = 'models/royscars/mazda/mazda_rx8_r3.mdl',
    ...
    FrontRelativeDamping = 1615, 
    RearRelativeDamping = 1615,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_mazda_rx8_r3', V ) 