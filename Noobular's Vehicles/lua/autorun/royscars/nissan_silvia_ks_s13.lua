...
local V = { 
    ...
    Name = 'S13kroy',
    Model = 'models/royscars/nissan/nissan_silvia_ks_s13.mdl',
    ...
    FrontRelativeDamping = 1448, 
    RearRelativeDamping = 1448,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_nissan_silvia_ks_s13', V ) 