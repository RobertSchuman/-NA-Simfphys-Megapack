...
local V = { 
    ...
    Name = 'RS500roy',
    Model = 'models/royscars/ford_cos_rs500.mdl',
    ...
    FrontRelativeDamping = 2623, 
    RearRelativeDamping = 2623,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_ford_cos_rs500', V ) 