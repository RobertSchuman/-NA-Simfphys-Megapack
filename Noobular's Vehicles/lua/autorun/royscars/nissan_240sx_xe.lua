...
local V = { 
    ...
    Name = '240SXXEroy',
    Model = 'models/royscars/nissan/nissan_240sx_xe.mdl',
    ...
    FrontRelativeDamping = 1482, 
    RearRelativeDamping = 1482,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_nissan_240sx_xe', V ) 