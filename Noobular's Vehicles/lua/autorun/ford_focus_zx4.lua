...
local V = { 
    ...
    Name = 'zx4roy',
    Model = 'models/royscars/ford_focus_zx4.mdl',
    ...
    FrontRelativeDamping = 1423, 
    RearRelativeDamping = 1423,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_royscars_ford_focus_zx4', V ) 