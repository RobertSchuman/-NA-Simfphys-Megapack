...
local V = { 
    ...
    RearWheelRadius = 15.659999847412,
    ...
    FrontRelativeDamping = 2329, 
    RearRelativeDamping = 2329,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_crsk_autos_s5_2017', V ) 