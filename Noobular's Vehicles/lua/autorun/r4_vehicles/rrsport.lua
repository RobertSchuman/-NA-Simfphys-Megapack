...
local V = { 
    ...
    Name = 'r4_rrsport',
    Model = 'models/r4_vehicles/landrover/rrsport.mdl',
    ...
    FrontRelativeDamping = 2956, 
    RearRelativeDamping = 2956,
...
list.Set( 'simfphys_vehicles', 'simfphys_NV_r4_vehicles_rrsport', V ) 